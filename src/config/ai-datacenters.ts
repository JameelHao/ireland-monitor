...
const IRELAND_AI_DATA_CENTERS: AIDataCenter[] = [
  {
    id: 'ie-dc-aws-dublin-campus',
    name: 'AWS Dublin Region Data Center Campus',
    owner: 'Amazon Web Services',
    country: 'Ireland',
    lat: 53.3498,
    lon: -6.2603,
    status: 'existing',
    chipType: 'Mixed AI GPU Cluster',
    chipCount: 12000,
    powerMW: 140,
    sector: 'Private',
    note: 'Estimated AI capacity in the broader Dublin AWS campus footprint.',
  },
  {
    id: 'ie-dc-microsoft-dublin',
    name: 'Microsoft Grange Castle Data Center Campus',
    ...
    powerMW: 120,
    sector: 'Private',
    note: 'Represents AI-serving capacity within Microsoft Dublin facilities.',
  },
  {
    id: 'ie-dc-google-dublin',
    name: 'Google Dublin Data Center Operations',
    owner: 'Google Cloud',
    country: 'Ireland',
    lat: 53.3362,
    lon: -6.2397,
    status: 'existing',
    chipType: 'TPU/GPU Mixed',
    chipCount: 9000,
    powerMW: 95,
    sector: 'Private',
    note: 'Approximate AI compute footprint across Google Dublin operations.',
  },
  {
    id: 'ie-dc-equinix-db',
    name: 'Equinix Dublin International Business Exchange (DB Sites)',
    owner: 'Equinix',
    country: 'Ireland',
    lat: 53.4084,
    lon: -6.2798,
    status: 'existing',
    chipType: 'Colocation AI GPU Racks',
    chipCount: 6000,
    powerMW: 60,
    sector: 'Private',
    note: 'Colocation footprint used by cloud and AI workloads.',
  },
  {
    id: 'ie-dc-keppel-dublin',
    name: 'Keppel Dublin Data Center Campus',
    owner: 'Keppel Data Centres',
    country: 'Ireland',
    lat: 53.4022,
    lon: -6.322,
    status: 'planned',
    chipType: 'AI-Ready Colocation',
    chipCount: 8000,
    powerMW: 100,
    sector: 'Private',
    note: 'Planned AI-ready capacity in Dublin metro expansion.',
  },
  {
    id: 'ie-dc-vantage-dublin',
    name: 'Vantage Dublin Campus',
    owner: 'Vantage Data Centers',
    country: 'Ireland',
    lat: 53.2891,
    lon: -6.3727,
    status: 'planned',
    chipType: 'AI/HPC-Ready GPU Capacity',
    chipCount: 7000,
    powerMW: 90,
    sector: 'Private',
    note: 'Planned hyperscale expansion suitable for AI/HPC tenants.',
  },
];

export const AI_DATA_CENTERS: AIDataCenter[] = [
  ...IRELAND_AI_DATA_CENTERS,
  {
    id: 'dc-1',
